...
export default function MasterIndikatorUtama() {
  ...
  const executeDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      await api.delete(`/api/master-indikator-utama/${deleteId}`);
      fetchData(); // Refresh data
      cancelDelete();
    } catch (err: any) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm overflow-hidden">
            <div className="p-6 text-center">
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-2">Hapus Indikator Utama?</h2>
              <p className="text-sm text-slate-500 mb-6">
                Apakah Anda yakin ingin menghapus indikator utama ini? Tindakan ini tidak dapat dibatalkan.
              </p>
